...
from proxy_code import async_get_page_source_with_proxy_with_selector ,async_get_page_source_without_proxy
...
async def process_product(country, gender, pid, date_subfolder):
    ...
    try:
        ...
        html_content = await async_get_page_source_with_proxy_with_selector(url, ['script#__NEXT_DATA__'])
