...
COLLECTION_PREFIX = 'crawler_sink_brooks_'

today_str = datetime.now().strftime('%Y-%m-%d')
# today_str = '2025-11-17'
THRESHOLD_PERCENT = 25.0  # Don't upload if today's count differs by more than the set percentage
