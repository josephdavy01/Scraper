...
if __name__ == "__main__":
    ...
    if day in ['Monday', 'Wednesday', 'Friday']:
        collections = {
            'Saudi' : ['crawler_sink_h&m_saudi', 'crawler_sink_h&m_saudi_kids'],
            'UAE' : ['crawler_sink_h&m_uae', 'crawler_sink_h&m_uae_kids']
        }
    elif day in ['Tuesday', 'Thursday', 'Saturday']:
        collections = {
            'India' : ['crawler_sink_h&m_india', 'crawler_sink_h&m_india_kids'],
            'UK' : ['crawler_sink_h&m_uk', 'crawler_sink_h&m_uk_kids']
        }
    else:
        collections = { }
