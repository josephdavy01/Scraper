...
def process_country_data(country, fetch_date):
    ...
    # Input file matches the output from step 6: {country}_data.json
    input_file = os.path.join(folder, f'{country}_data.json')
    # Log file for duplicates
    log_file = os.path.join(folder, 'duplicate_skus.json')
