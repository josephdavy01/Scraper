...
if __name__ == "__main__":
    ...
    if day in ['Monday','Wednesday', 'Friday']:
        collections = {
            'India' : ['crawler_sink_asics_india','crawler_sink_asics_india_footwear'],
            'UAE' : ['crawler_sink_asics_uae', 'crawler_sink_asics_uae_footwear']
        }
    else:        collections = {
            'UK' : ['crawler_sink_asics_uk', 'crawler_sink_asics_uk_footwear'],
            'USA' : ['crawler_sink_asics_usa', 'crawler_sink_asics_usa_footwear']
        }
