...
def get_unique_urls_uae(country, today_str):
        ...
        read_file_path = f'{base_dir}/{country}_product_urls_ids.json'  # Fixed filename
        write_file_path = f'{base_dir}/{country}_unique_product_urls_ids.json'  # Updated output filename
        ...
        for gender, categories in url_dict.items():
            ...
            for category, products in categories.items():
                ...
                logging.info(f"Category {gender}/{category}: {len(unique_products)} unique products")
        ...
        try:
            ...
            logging.info(f"Total unique products after deduplication: {total_unique}")
