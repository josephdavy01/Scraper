...
if __name__ == "__main__":
    ...
    collections = {
        "UAE": ["crawler_sink_on_uae_footwear", "crawler_sink_on_uae"],
        "UK": ["crawler_sink_on_uk_footwear", "crawler_sink_on_uk"],
        "USA": ["crawler_sink_on_usa_footwear", "crawler_sink_on_usa"]
    }
