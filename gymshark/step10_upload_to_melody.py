...
SERVER_MONGO_URI = 'replace_with_actul_server_string'
LOCAL_MONGO_URI = 'mongodb://localhost:27017'
DB_NAME = 'tg_analytics'
COLLECTION_PREFIX = 'crawler_sink_gymshark_'
...
active_countries = MON_WED_FRI if day in ['Monday', 'Wednesday', 'Friday'] else {}
