...
THRESHOLD_PERCENT = 25  # Don't upload if today's count differs by more than the set percentage
CHUNK_SIZE = 5000  # Number of docs per insert chunk
ALLOW_REUPLOAD = True  # Set True to delete and re-upload for the same day
...
for country in active_countries:
    ...
    if server_data_count:
        if server_data_count == today_count:
            ...
            logging.info(f"Skipping {country.upper()} - data exists and reupload is disabled.")
            continue
        else:
