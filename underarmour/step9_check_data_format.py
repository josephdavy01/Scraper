...
if __name__ == "__main__":
    ...
    if day in ['Monday', 'Wednesday', 'Friday']:
        collections = {
            'India' : ['crawler_sink_underarmour_india_footwear', 'crawler_sink_underarmour_india'],
            'UAE' : ['crawler_sink_underarmour_uae_footwear', 'crawler_sink_underarmour_uae']
        }
    elif day in ['Tuesday', 'Thursday', 'Saturday']:
        collections = {
            'UK' : ['crawler_sink_underarmour_uk_footwear', 'crawler_sink_underarmour_uk'],
            'USA' : ['crawler_sink_underarmour_usa_footwear', 'crawler_sink_underarmour_usa']
        }
    else:
        collections = { }
