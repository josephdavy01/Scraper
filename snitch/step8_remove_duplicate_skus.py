...
def process_country_data(country, fetch_date, file_type):
    ...
    # Input file matches the output from step 6: {country}_data_{file_type}.json
...
def remove_duplicates_from_json(countries, fetch_date):
    ...
    for country in country_list:
        ...
        for file_type in ['apparel', 'footwear']:
            process_country_data(country, fetch_date, file_type)
