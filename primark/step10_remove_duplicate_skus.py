...
if __name__ == "__main__":
    ...
    for country in countries:
        ...
        collections = [f'crawler_sink_primark_{geography}', f'crawler_sink_primark_{geography}_kids',f'crawler_sink_primark_{geography}_footwear', f'crawler_sink_primark_{geography}_kids_footwear']
