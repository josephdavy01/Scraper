...
def create_individual_json(base_url, today_str, json_data, gender):
    ...
    for product in products:
        ...
        for size in product['variants']:
            sku = size['sku']
            sizename = str(size['displaySize'].strip())
...
if __name__ == "__main__":
    ...
    countries = {
        'UK' : 'https://www.primark.com/en-gb/p/'
    }

    for country, base_url in countries.items():
        collection = db[f'crawler_sink_primark_{country.lower()}']
