...
# pop_keys = ['accessories_bags_and_backpacks', 'accessories_hats_and_beanies', 'accessories_socks', 'accessories_sports_equipment', 'accessories_socks_and_underwear','accessories_bags_&_backpacks' ,'boys_accessories', 'girls_accessories', 'women_accessories', 'men_accessories', 'kids_accessories', 'back_to_school_backpacks_and_more']
pop_keys = []
