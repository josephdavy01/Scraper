...
# pop_keys = ['accessories_caps_and_beanies', 'accessories_backpacks', 'accessories_bags_gym_and_casual', 'accessories_socks', 'accessories_gloves', 'accessories_sports_equipment', 'accessories_wallets', 'accessories_water_bottles', 'accessories_motorsport', 'boys_bags_and_accessories', 'girls_bags_and_accessories', 'mens_sale_accesories', 'womens_sale_accessories', 'kids_sale_accessories', 'running_accessories', 'training_gym_bags_and_accessories', 'cricket_cricket_gear_and_accessories', 'football_footballs_and_accessories', 'motorsport_accessories']
pop_keys = []

countries = {
    'INDIA': 'https://in.puma.com/in/en'
}
