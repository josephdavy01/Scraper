...
if __name__ == "__main__":
    ...
    if day in ['Monday', 'Wednesday', 'Friday']:
        ...
        collections = {
            # "USA": ["crawler_sink_puma_usa", "crawler_sink_puma_usa_footwear","crawler_sink_puma_usa_kids"],
            "INDIA":["crawler_sink_puma_india", "crawler_sink_puma_india_footwear","crawler_sink_puma_india_kids"]
        }
    elif day in ['Tuesday', 'Thursday', 'Saturday']:
        collections = {
            "UAE": ["crawler_sink_puma_uae", "crawler_sink_puma_uae_footwear","crawler_sink_puma_uae_kids"],
            "UK": ["crawler_sink_puma_uk", "crawler_sink_puma_uk_footwear","crawler_sink_puma_uk_kids"],
        }
    else:
        collections = {}
