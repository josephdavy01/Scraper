...
if __name__ == "__main__":
    ...
    if day in ['Monday', 'Wednesday', 'Friday']:
        collections = {
            'Australia' : ['crawler_sink_zara_australia', 'crawler_sink_zara_australia_kids'],
            'Canada' : ['crawler_sink_zara_canada', 'crawler_sink_zara_canada_kids'],
            'India' : ['crawler_sink_zara_india', 'crawler_sink_zara_india_kids'],
            'Saudi' : ['crawler_sink_zara_saudi', 'crawler_sink_zara_saudi_kids'],
            'Spain' : ['crawler_sink_zara_spain', 'crawler_sink_zara_spain_kids']
        }
    elif day in ['Tuesday', 'Thursday', 'Saturday']:
        collections = {
            'Turkey' : ['crawler_sink_zara_turkey', 'crawler_sink_zara_turkey_kids'],
            'UAE' : ['crawler_sink_zara_uae', 'crawler_sink_zara_uae_kids'],
            'UK' : ['crawler_sink_zara_uk', 'crawler_sink_zara_uk_kids'],
            'USA' : ['crawler_sink_zara_usa', 'crawler_sink_zara_usa_kids']
        }
    else:
        collections = { }
