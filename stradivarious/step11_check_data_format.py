...
if __name__ == "__main__":
    ...
    if day in ['Monday', 'Wednesday', 'Friday']:
        collections = {
                'Canada' : 'crawler_sink_stradivarius_canada',
                'Saudi' : 'crawler_sink_stradivarius_saudi',
                'Spain' : 'crawler_sink_stradivarius_spain',
                'Turkey' : 'crawler_sink_stradivarius_turkey'
            }
    elif day in ['Tuesday', 'Thursday', 'Saturday']:
        collections = {
                'UAE' : 'crawler_sink_stradivarius_uae',
                'UK' : 'crawler_sink_stradivarius_uk',
                'USA' : 'crawler_sink_stradivarius_usa'
            }
    else:
        collections = { }
