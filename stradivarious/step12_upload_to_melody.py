...
COLLECTION_PREFIX = 'crawler_sink_stradivarius_'

MON_WED_FRI = ['canada', 'saudi', 'spain', 'turkey']
TUE_THU_SAT = ['uae', 'uk', 'usa']

today_str = datetime.now().strftime('%Y-%m-%d')
# today_str = '2025-11-05'
THRESHOLD_PERCENT = 1000# Don't upload if today's count differs by more than the set percentage
