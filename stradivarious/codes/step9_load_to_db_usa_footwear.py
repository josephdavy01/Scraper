...
if __name__ == "__main__":
    ...
    if day in ['Tuesday', 'Thursday', 'Saturday','Friday']:
        ...
        collection = db['crawler_sink_stradivarius_usa_footwear']
        ...
        print(f"Processing data for {today_str} in USA...")
        ...
        print(f"Today is {day}. No data processing required for USA {today_str}.")