...
if __name__ == "__main__":
    ...
    if day in ['Tuesday', 'Thursday', 'Saturday','Friday']:
        ...
        collection = db['crawler_sink_stradivarius_uae_footwear']
        ...
        print(f"Processing data for {today_str} in uae...")
        ...
        print(f"Today is {day}. No data processing required for uae {today_str}.")