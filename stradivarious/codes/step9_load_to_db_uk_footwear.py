...
if __name__ == "__main__":
    ...
    if day in ['Tuesday', 'Thursday', 'Saturday','Friday']:
        ...
        collection = db['crawler_sink_stradivarius_uk_footwear']
        ...
        print(f"Processing data for {today_str} in UK...")
        ...
        print(f"Today is {day}. No data processing required for UK {today_str}.")