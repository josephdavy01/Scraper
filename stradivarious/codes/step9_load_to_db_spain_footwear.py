...
if __name__ == "__main__":
    ...
    if day in ['Tuesday', 'Thursday', 'Saturday','Friday']:
        ...
        collection = db['crawler_sink_stradivarius_spain_footwear']
        ...
        print(f"Processing data for {today_str} in spain...")
        ...
        print(f"Today is {day}. No data processing required for spain {today_str}.")