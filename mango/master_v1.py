...
from steps.step4_update_pid import update_pids
from steps.step5_process_apparel import process_apparel
from steps.step5_process_footwear import process_footwear
                ...
                try:
                    if step == "Step 3: Scrape Data":
                        ...
                        if os.path.exists(json_data_dir):
                            scrap_logs = [os.path.join(json_data_dir, f) for f in os.listdir(json_data_dir) if 'scrap_log.json' in f]
                            if scrap_logs:
                    ...
                    elif step == "Step 5: Process Footwear":
...
DAY = datetime.strptime(TODAY_DATE, '%Y-%m-%d').strftime('%A')

if DAY in ['Monday', 'Wednesday', 'Friday']:
    COUNTRIES = ['India', 'Saudi', 'UAE']
    CONFIG = {
        'India': {
            'base':'https://shop.mango.com',
            'base_url': 'https://shop.mango.com/ws-menu/v4/menu/shop/IN/en',
            'domain': 'https://shop.mango.com/in/en',
            'use_proxies': False,
            'proxies': {
            ...
            'browsers_product_data': 2,
            'browsers_product_urls':2,
            'exclude_urls': [
                "https://shop.mango.com/in/en/c/women/private-sales_e591d88c",
                "https://shop.mango.com/in/en/c/women/see-all_a5143b28",
                "https://shop.mango.com/in/en/c/men/see-all_c6638443"
            ]
        },
        'Saudi': {
            'base':'https://shop.mango.com',
            'base_url': 'https://shop.mango.com/ws-menu/v4/menu/shop/SA/en',
            'domain': 'https://shop.mango.com/sa/en',
            'use_proxies': False,
            'proxies': {
                "server": "p.webshare.io:80",
                "username": "hkzhowmh-rotate",
            ...
            'browsers_product_urls':2,
            'exclude_urls': [
                "https://shop.mango.com/sa/en/c/women/private-sales_e591d88c",
                "https://shop.mango.com/sa/en/c/women/see-all_a5143b28",
                "https://shop.mango.com/sa/en/c/men/see-all_c6638443"
            ]
        },
        'UAE': {
            'base':'https://shop.mango.com',
            'base_url': 'https://shop.mango.com/ws-menu/v4/menu/shop/AE/en',
            'domain': 'https://shop.mango.com/ae/en',
            'use_proxies': False,
            'proxies': {
                "server": "p.webshare.io:80",
                "username": "hkzhowmh-rotate",
            ...
            'browsers_product_urls':2,
            'exclude_urls': [
                "https://shop.mango.com/ae/en/c/women/private-sales_e591d88c",
                "https://shop.mango.com/ae/en/c/women/see-all_a5143b28",
                "https://shop.mango.com/ae/en/c/men/see-all_c6638443"
            ]
        }
    }
    ...
    CONFIG = {
        'UK': {
            'base':'https://shop.mango.com',
            'base_url': 'https://shop.mango.com/ws-menu/v4/menu/shop/GB/en',
            'domain': 'https://shop.mango.com/gb/en',
            'use_proxies': False,
            'proxies': {
                "server": "p.webshare.io:80",
                "username": "hkzhowmh-rotate",
            ...
            'browsers_product_data': 3,
            'browsers_product_urls':3,
            'exclude_urls': [
                "https://shop.mango.com/gb/en/c/women/private-sales_e591d88c",
                "https://shop.mango.com/gb/en/c/women/see-all_a5143b28",
                "https://shop.mango.com/gb/en/c/men/see-all_c6638443"
            ]
        },
        'USA': {
            'base':'https://shop.mango.com',
            'base_url': 'https://shop.mango.com/ws-menu/v4/menu/shop/US/en',
            'domain': 'https://shop.mango.com/us/en',
            'use_proxies': False,
            'proxies': {
                "server": "p.webshare.io:80",
                "username": "hkzhowmh-rotate",
            ...
            'browsers_product_urls':3,
            'exclude_urls': [
                "https://shop.mango.com/us/en/c/women/private-sales_e591d88c",
                "https://shop.mango.com/us/en/c/women/see-all_a5143b28",
                "https://shop.mango.com/us/en/c/men/see-all_c6638443"
            ]
        }
    }
else:
    exit("No scripts scheduled to run today.")
...
EXECUTION_CONFIG = {
    ...
    'step3_rerun': False,
    #Update PIDs
    'step4_update_pids': True,
    #Process Footwear
    'step5_process_footwear': True,
    'step5_process_footwear_rerun': False,
    #Process Apparel
...
def main():
    ...
    if EXECUTION_CONFIG['step3_scrape_data']:
        ...
        step_start = datetime.now(IST)
        try:
            status_dict = get_product_data(CONFIG, TODAY_DATE, re_run=EXECUTION_CONFIG.get('step3_rerun', False))
            
            for country, status in status_dict.items():
                if status == 'success':
                    print(f"Calculating deviation for {country}...")
                    log_file_path = os.path.join(country, TODAY_DATE, 'Json_data', f'{country}_product_url_scrap_log.json')
    ...
    # 4. Update PIDs
    if EXECUTION_CONFIG['step4_update_pids']:
        step_name = "Step 4: Update PIDs"
        log_step_execution(COUNTRIES, step_name, "Started")
        step_start = datetime.now(IST)
        try:
            update_pids(COUNTRIES, TODAY_DATE)
        except Exception as e:
            logging.error(f"Step 4 Update PIDs Failed: {e}")
            raise_ticket("Step 4", "update_pids", str(e))
    ...
    if EXECUTION_CONFIG['step5_process_footwear']:
        step_name = "Step 5: Process Footwear"
        log_step_execution(COUNTRIES, step_name, "Started")
        step_start = datetime.now(IST)
        try:
