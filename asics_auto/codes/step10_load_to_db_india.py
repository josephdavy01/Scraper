    ...
    try:
        ...
        for attribute in attributes:
            ...
            if metadata == 'Upper Material':
                composition = attribute['entered_attribute_value']['value'].strip().lower()
            if metadata == 'GENDER':
        ...
        if gender in ['female', 'male', 'unisex'] and product_type not in ['shoes', 'flip flop and slides']:
            ...
            print(f"Skipping product {url_key} as it is a footwear.")
            return []
    except:
        return []
