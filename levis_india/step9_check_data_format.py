...
if __name__ == "__main__":
    ...
    if day in ['Monday', 'Wednesday', 'Friday']:
        collections = {
            'India' : ['crawler_sink_mango_india', 'crawler_sink_mango_india_kids'],
            'Saudi' : ['crawler_sink_mango_saudi', 'crawler_sink_mango_saudi_kids'],
            'UAE' : ['crawler_sink_mango_uae', 'crawler_sink_mango_uae_kids'],
        }
    elif day in ['Tuesday', 'Thursday', 'Saturday']:
        collections = {
            'UK' : ['crawler_sink_mango_uk', 'crawler_sink_mango_uk_kids'],
            'USA' : ['crawler_sink_mango_usa', 'crawler_sink_mango_usa_kids']
        }
    else:
        collections = { }
