...
SERVER_MONGO_URI = 'mongodb://root:iK&dsCaTio976fghI*(bgdskk)~@3.1.227.250:28018/tg_analytics?authSource=admin'  # Change to your server URI
...
for country in active_countries:
    ...
    server_collection = server_db[local_collection_name]
