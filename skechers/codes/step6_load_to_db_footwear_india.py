...
def create_individual_json(today_str, json_data, file_name):
    ...
    try:
        ...
        if generic in ['clog', 'sandal', 'slide', 'slip ins', 'slipper', 'shoe']:
            ...
            print(f"Skipping file {file_name} as it is not footwear.")
...
if __name__ == "__main__":
    ...
    for country in countries:
        collection = db[f'crawler_sink_skechers_{country.lower()}_footwear']
